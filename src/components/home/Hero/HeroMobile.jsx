...
function getMaskSizes(width) {
  if (width > 400 && width <= 600) {
    ...
    return { min: 60, max: 900 }; // default (>600)
  }
}
...
export const HeroMobile = () => {
  ...
  // Scroll-to-play logic (pause if top, play when scroll starts)
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    // Fade out .towardFadeDiv after scrolling 200px
  ...
  return (
    <>
      ...
      <div ref={parentRef} id="hero" className="parent h-[300vh] w-full relative">
